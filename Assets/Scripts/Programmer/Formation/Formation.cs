...
namespace Model.Formation
{
    public abstract class Formation
    {
        ...
        {
            var programmersInStage = StageManager.Instance.Unit.Programmers.Where(programmer => programmer.Status.IsOnVacation == false);
        ...
        {
            var stageField = StageManager.Instance.StageField;
            var programmers = StageManager.Instance.Unit.Programmers.Where(programmer => programmer.Status.IsOnVacation == false);
